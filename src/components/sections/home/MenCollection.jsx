...
export default function MenCollection() {
  ...
  return (
    <section className="w-full md:py-10 py-0 bg-[#F2F3F5] relative">
      ...
      <div className="max-w-7xl mx-auto px-4 flex flex-col items-end justify-center">
        ...
        <div className="flex flex-col md:flex-row gap-6 items-start justify-between relative w-full">
          ...
          {/* LEFT IMAGE */}
          <div className="hidden md:block w-[25%] relative">
            <img src="/loop.svg" className="absolute top-48 left-0 w-full" alt="" />
            <img
              src="/menn.png"
          ...
          {/* SLIDER WRAPPER — FIX RESPONSIVE */}
          <div className="w-full md:w-[75%] relative md:absolute md:top-8 md:right-14">

            {/* Title + Arrows */}
            <div className="flex items-center justify-between mb-4 w-full pl-0 md:pl-16 pt-4">
